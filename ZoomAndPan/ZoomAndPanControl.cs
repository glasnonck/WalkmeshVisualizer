    ...
    public partial class ZoomAndPanControl : ContentControl, IScrollInfo
    {
        ...
        public void AnimatedZoomTo(double newScale, Rect contentRect)
        {
            AnimatedZoomPointToViewportCenter(
                ...
                {
                    //
                    // At the end of the animation, ensure that we are snapped to the specified content
                    // offset. Due to zooming in on the content focus point and rounding errors, the
                    // content offset may be slightly off what we want at the end of the animation and
                    // this bit of code corrects it.
                    //
